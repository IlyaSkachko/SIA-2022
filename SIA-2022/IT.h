...
#define SYM_DEFAULT		0x00					//значение по умолчанию для symbol;
#define BOOL_DEFAULT   0x00000000
...
namespace IT
{	
	enum IDDATATYPE { NUM = 1, STR = 2, PROC = 3, SYM = 4, BOOL = 5, UNDEF };//типы данных идентификаторов: числовой, строковый, символьный, логический ,без типа(для процедур), неопределенный
